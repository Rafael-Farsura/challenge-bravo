...
describe('CurrencyService', () => {
    ...
    describe('create', () => {
        ...
        it('should add a fictional currency', async () => {
            ...
            jest.spyOn(service as any, 'isFictionalCurrency').mockResolvedValue(
                true,
            );
            ...
            jest.spyOn(service as any, 'validateCurrency').mockReturnValue(
                true,
            );
        ...
        it('should add a non-fictional currency', async () => {
            ...
            jest.spyOn(service as any, 'fetchExchangeRate').mockResolvedValue(
                1.2,
            );
            mockCurrencyRepository.create = jest.fn().mockReturnValue({
                code: 'ABC',
    ...
    describe('findAllCurrencies', () => {
        it('should return list of currencies', async () => {
            ...
            mockCurrencyRepository.find = jest
                .fn()
