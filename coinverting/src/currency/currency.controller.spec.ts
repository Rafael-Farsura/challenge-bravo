...
describe('CurrencyController', () => {
    ...
    beforeEach(async () => {
        mockCurrencyService = {
            ...
            findAllCurrencies: jest
                .fn()
                .mockResolvedValue(['USD', 'EUR', 'BRL']),
    ...
    describe('convert', () => {
        it('should successfully convert currency', async () => {
            ...
            (mockCurrencyService.convert as jest.Mock).mockResolvedValue(
                mockResult,
            );
    ...
    describe('create', () => {
        it('should successfully add a currency', async () => {
            ...
            (mockCurrencyService.create as jest.Mock).mockResolvedValue(
                undefined,
            );
    ...
    describe('findAllCurrencies', () => {
        it('should return supported currencies', async () => {
            ...
            (
                mockCurrencyService.findAllCurrencies as jest.Mock
    ...
    describe('findOneCurrency', () => {
        it('should return supported currency', async () => {
            ...
            (
                mockCurrencyService.findOneCurrency as jest.Mock
            ).mockResolvedValue(mockCurrency);

            const result = await controller.findOne('USD');

            expect(result).toEqual(mockCurrency);
            expect(mockCurrencyService.findOneCurrency).toHaveBeenCalledWith(
                'USD',
            );
        });
    });
